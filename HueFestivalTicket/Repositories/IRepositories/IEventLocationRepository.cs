...
namespace HueFestivalTicket.Repositories.IRepositories
{
    public interface IEventLocationRepository : IRepository<EventLocation>
    {
        ...
        public Task<object> GetEventLocationPagingAsync(int pageNumber, int pageSize);
        ...
        public Task UpdateStatusEventLocationAsync(EventLocation eventLocation, bool status);
